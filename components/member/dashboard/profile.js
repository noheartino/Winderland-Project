      ...
      <div className="container d-none d-lg-block">
        ...
        <div className="edit-card d-flex  ">
          <section className="editAccount-card me-5 col-6">
            ...
            <input type="tel" placeholder={3} style={{ width: '50%' }} />
            <br />
            <input
              type="text"
          ...
          <section className="editPwd-card col-6">
            <h5>修改密碼</h5>
            <label htmlFor="expwdLabel">舊密碼</label>{' '}
            <span>*舊密碼輸入錯誤</span>
            <input
              type="text"
              name=""
            ...
            />
            <br />
            <label htmlFor="newpwdLabel">新密碼</label>
            <input
              type="text"
              name=""
              id=""
            ...
            />
            <br />
            <label htmlFor="pwd2Label">再次輸入新密碼</label>{' '}
            <span>*密碼內容輸入錯誤</span>
            <input
              type="text"
              name=""
      ...
      >
        ...
        <div className="edit-card edit-card-rwd">
          <section className="editAccount-card-rwd me-5 ">
            ...
            <input type="tel" placeholder={1} style={{ width: '50%' }} />
            <br />
            <input
              type="text"
              placeholder="桃園市中壢區新生路二段421號"
