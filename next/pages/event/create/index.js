...
//     useEffect(() => {
//         fetch(`http://localhost:3005/api/event-cin`)
...
//                     <div className="container">
//                         <form action="http://localhost:3005/api/event-cin" method="post" encType="multipart/form-data">
//                             <div className="row">
...
export default function Applyevent() {
    ...
    const nowEventId = (infodata && infodata.applyon && Array.isArray(infodata.applyon)) 
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (response.ok) {
                router.push('http://localhost:3000/event/list'); 
                ...
                <div className="container">
                    <form onSubmit={handleSubmit}>
                        <div className="row">
                            <div className="col-12 col-lg-8">
                                <div className="row gx-2 gx-lg-4">
                                    <div className="col-12">
                                        ...
                                        <input type="hidden" name="myage" value={calculateAge(birthday)} />
                                        <input type="hidden" name="kotoba" value={`[開團人本人]`} />

                                        <label htmlFor="eventName" className="CreateWriteT">活動標題</label>
                                        <input
                                            type="text"
                                            name="event_name"
                                            id="eventName"
                                    ...
                                    <div className="col-4">
                                        <label htmlFor="eventDate" className="CreateWriteT">活動日期</label>
                                        <input
                                            type="date"
                                            name="event_date"
                                            id="eventDate"
                                    ...
                                    <div className="col-4">
                                        <label htmlFor="eventTimeS" className="CreateWriteT">活動開始時間</label>
                                        <input
                                            type="time"
                                            name="event_time_start"
                                            id="eventTimeS"
                                    ...
                                    <div className="col-4">
                                        <label htmlFor="eventTimeE" className="CreateWriteT">活動結束時間</label>
                                        <input
                                            type="time"
                                            name="event_time_end"
                                            id="eventTimeE"
                                    ...
                                    <div className="col-4">
                                        <label htmlFor="eventApplyS" className="CreateWriteT">報名開始日</label>
                                        <input
                                            type="date"
                                            name="apply_start"
                                            id="eventApplyS"
                                    ...
                                    <div className="col-4">
                                        <label htmlFor="eventApplyE" className="CreateWriteT">報名截止日</label>
                                        <input
                                            type="date"
                                            name="apply_end"
                                            id="eventApplyE"
                                    ...
                                    <div className="col-4">
                                        <label htmlFor="eventLimit" className="CreateWriteT">人數上限</label>
                                        <input
                                            type="number"
                                            name="people_limit"
                                            id="eventLimit"
                                    ...
                                    <div className="col-4">
                                        <label htmlFor="eventCity" className="CreateWriteT">活動城市</label>
                                        <input
                                            type="text"
                                            name="event_city"
                                            id="eventCity"
                                    ...
                                    <div className="col-8">
                                        <label htmlFor="eventShop" className="CreateWriteT">活動地標名</label>
                                        <input
                                            type="text"
                                            name="event_venue"
                                            id="eventShop"
                                    ...
                                    <div className="col-12">
                                        <label htmlFor="eventAdress" className="CreateWriteT">活動詳細地址</label>
                                        <input
                                            type="text"
                                            name="event_address"
                                            id="eventAdress"
                            ...
                            <div className="col-12 col-lg-4">
                                <label htmlFor="eventPic" className="form-label CreateWriteT">活動形象圖</label>
                                <img src={image} alt="" className="prevpic" />
                                <input
                                    className="form-control"
                                    type="file"
                            ...
                            <div className="col-12 mt-3 mt-lg-0">
                                <label htmlFor="eventIntro" className="CreateWriteT">活動介紹</label>
                                <textarea
                                    name="event_introduce"
                                    id="eventIntro"
                                    placeholder="活動詳細說明"
                            ...
                            <div className="col-12 d-flex justify-content-end mt-3">
                                <button onClick={clearhandleInput} className="eventCR">清空</button>
                                <button type="submit" className="eventCS d-block">新增活動</button>
                            </div>
                        </div>
                    </form>
                </div>
