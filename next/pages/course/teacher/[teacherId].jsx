...
if(teacherComments && teacherComments.length>0){
  averageRating = (teacherComments.reduce((acc, v)=>acc+v.rating,0)/teacherComments.length).toFixed(1)
}
  return (
    <>
          ...
          <div className="container-fluid px-0 teacher-detail-banner rounded-bottom-5 overflow-hidden d-flex justify-content-center align-items-center pb-5">
            <div className="d-flex flex-column align-items-center gap-4">
              <div className="teacher-detail-head col-auto me-3 px-0">
                <Image src={`/images/course_and_tarot/${teacher?.teacher_path}`} width={100} height={100} alt="" />
              </div>
              <div className="teacher-card-name d-flex flex-column align-items-center">
                <div className="display-6 spac-2 text-white lh-15">{teacher?.name}</div>
              ...
              <Link href={`/course/teacher`} className="spac-1 btn-border-white btn mb-5 px-4 py-2 rounded-4">
            ...
            <div className="container-sm">
              <div className="teacher-detail-content-box w-100 rounded-5 m-auto">
                <div className="d-none d-md-flex flex-column justify-content-center align-items-center">
                  ...
                  <div
                className={`stars mt-2 d-flex align-items-center`}
              >
                <i
                  className={`fa-solid fa-star ${
                    averageRating > 0.5
                ...
                <h6 className="text-prim-dark spac-2 lh-20 teacher-intro-text mb-5" style={{whiteSpace: "pre-line"}}>
                  {teacher?.description}
                </h6>
              </div>
            </div>
                   ...
                   <div className="h3 pe-2 spac-2 m-0 text-prim-text-prim px-10px mb-5 text-center text-md-start">
                    ...
                    <div className="row px-0 mx-0 course-mycourse-box row-gap-5">
                      ...
                      {teacherCourses.map((teacherCourse)=>{
                        return (
                          <div key={teacherCourse.id} className="col-12 col-md-4 col-xl-3 px-20px d-flex flex-column align-items-center justify-content-between">
                            <CourseCardSm course={teacherCourse} averageRating={averageRating} classAssignsQ={teacherCourse.assigned}/>
                          </div>
                        )
                      })}
                      {/* card-sm online end */}
