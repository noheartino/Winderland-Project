        ...
        <div className="fourth-page-wrap">
          <div className="container-fluid px-0 teacher-detail-banner rounded-bottom-5 overflow-hidden d-flex justify-content-center align-items-center pb-5">
            <div className="d-flex flex-column align-items-center gap-4">
              <a className="teacher-detail-head col-auto me-3 px-0" href="/">
                <img
                ...
                <div className="h6 spac-2 lh-15 teacher-intro-text">
                  ...
                  <ul className="ps-4">
                    ...
                    <li>
                      ...
                      Vins de Bourgogne) 專家認證(2013): Honour of Burgundy Wine
                      Connoisseur
                    </li>
                    <li>Certificate</li>
                  </ul>
                  ...
                  <ul className="ps-4">
                    ...
                    <li>
                      Sopexa 亞洲最佳法國侍酒師比賽台灣代表, 準決賽入圍(Dec
                      2015)
                    </li>
                  </ul>
                  ...
                  <ul className="ps-4">
                    ...
                    <li>
                      玩高爾夫雜誌One Golf, Issue 45, Oct. 2014 page 86-87
                    </li>
                    <li>
                      The Drink Business: Taipei’s Top Sommeliers, 16th
            ...
            <div className="container-fluid my-5 px-0">
                <div className="w-100 bg-white m-auto teacher-detail-suggest-course">
                  ...
                  <div className="my-5 border-5">
                    ...
                    <div className="row px-0 course-mycourse-box row-gap-5">
                      ...
                      >
                        ...
                        <div className="row px-0 m-0 w-100">
                          ...
                          <div
                            className="progress mt-2 bg-sec-blue px-0 d-none"
                            role="progressbar"
                            aria-label=""
                            aria-valuenow={75}
                            aria-valuemin={0}
