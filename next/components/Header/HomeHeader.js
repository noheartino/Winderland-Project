...
export default function HomeNav() {
  ...
  const handleKeyPress = (event) => {
    if (event.key === "Enter") {
      ...
      router.push(
        `/product/?page=1&sort=id_asc&minPrice=0&maxPrice=150000&search=${encodeURIComponent(
          searchQuery
        )}`
      );
    }
  ...
  useEffect(() => {
    if (userId) {
      fetch(`https://winderland.shop/api/header/${userId}`)
  ...
  const redwine = () => {
    router.push("https://winderland.shop/product?page=1&sort=id_asc&category=1");
  };

  const whitewine = () => {
    router.push("https://winderland.shop/product?page=1&sort=id_asc&category=2");
  };

  const otherwine = () => {
    router.push("https://winderland.shop/product?page=1&sort=id_asc&category=3");
  };
      ...
      <div className={`HeaderCNav ${scrolled ? "" : "scroll"}`}>
        <div className="container d-none d-lg-flex">
          <a onClick={goHome} style={{ cursor: "pointer" }}>
            <img
              ...
              src={
                scrolled
                  ? "/nav-footer/nav_logo.png"
                  : "/nav-footer/nav_logo_b.png"
              }
              alt=""
              width={170}
            />
        ...
        <div className="HeaderNavRwd d-flex d-lg-none">
          ...
          <img
            ...
            src={
              scrolled
                ? "/nav-footer/nav_logo_rwd.png"
                : "/nav-footer/nav_logo_rwd_b.png"
            }
            alt=""
            width={100}
          />
